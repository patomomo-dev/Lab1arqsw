# Sistema de Transacciones Bancarias - Laboratorio Nro 1

Aplicación web transaccional bancaria de dos capas que permite la consulta de clientes, realización de transferencias entre cuentas y visualización del historial de transacciones.
...
**Para poder ejecutar el frontend, es obligatorio descargar `banco-frontend.zip` y extraer su contenido localmente.**
